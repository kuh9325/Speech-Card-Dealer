    ...
    speeches: [
      {
        id: "career-01",
        title: "나만의 사명",
        body: "모두 누구에게나 반드시 사명이 있습니다. 자기만이 할 수 있는 사명이 있습니다. 반드시 당신의 힘을 필요로 하는 사람이 반드시 어딘가에 있습니다. … 그것을 발견하려면 우선 눈앞의 ‘현실’에서 피하지 말아야 합니다. - 청춘대화 2권 p331",
        frontImage: ""
      },
      {
        id: "career-02",
        title: "인생은 마라톤",
        body: "인생은 ‘마라톤’입니다. 처음에는 꼴찌라 해도 상관없습니다. 그 때문에 자신을 포기하고 달리지 않으면 그것으로 ‘끝’입니다. 보잘것없는 인간이 되고 맙니다. 지금 꿈이 있는 사람도 없는 사람도 어쨌든 계속 달려야 합니다. - 청춘대화 2권 p339",
        frontImage: ""
      },
      {
        id: "career-03",
        title: "시작하는 습관",
        body: "결과는 아무래도 좋으니 우선 무엇인가를 시작해야 합니다. 무엇인가 노력해 보아야 합니다. 그러한 ‘도망가지 않는 습관’, ‘노력하는 습관’을 만들어야 합니다. - 청춘대화 2권 p348",
        frontImage: ""
      },
      {
        id: "career-04",
        title: "지지 않는 혼",
        body: "인간은 누구나 어떤 형태로든 콤플렉스를 가지고 있습니다. … 중요한 것은 그 콤플렉스에 ‘지지 않는’ 것입니다. 그 어떤 콤플렉스가 있다 해도 그것을 발판으로 삼아 인내하고 ‘두고 봐라!’ 하며 스스로를 격려하면서 나아가야 합니다. ‘지지 않는 혼’입니다. - 청춘대화 2권 p365",
        frontImage: ""
      },
      {
        id: "career-05",
        title: "노력의 습관",
        body: "유유하게 노력하는 ‘습관’을 붙인 사람은 장래 무슨 일이라도 극복할 수 있습니다. 그 ‘습관’이 최고의 재산입니다. 그러므로 지금 ‘눈앞의 과제에서 승리하라!’, ‘무엇인가를 시작하자!’고 호소하고 싶습니다. - 청춘대화 2권 p388",
        frontImage: ""
      }
    ]
  },
    ...
    speeches: [
      {
        id: "money-01",
        title: "인내 위의 행복",
        body: "지지 마라. 강한 마음에 행복이! 가장 고생한 사람이 최후에는 가장 큰 행복을 쟁취할 수 있다. 행복은 인내라는 대지에 피는 꽃이라는 것을 잊지 말아야 한다. - 「‘희망에서 피어난 행복이야기’ 발간」, 《화광신문》 2011년 10월 14일, 제944호",
        frontImage: ""
      },
      {
        id: "money-02",
        title: "인간성의 힘",
        body: "주위에서 ‘좋았다’고 칭찬받는 일은 바로 불법자로서 지닌 ‘인간성의 힘’이라고 말할 수 있습니다. ‘마음의 재’가 지닌 힘이 있기에 사람들에게서 신뢰받고, 모범적인 존재로 높이 평가받습니다. 불성이 빛나는 인간성으로 나타나고, 그 훌륭함이 신심하지 않는 사람들도 감동시킵니다. ‘저 사람은 정말 뭔가 다르다. 빛난다.’고 신뢰받는 일이 불법의 확고한 실증입니다. - 스슌천황어서 강독",
        frontImage: ""
      },
      {
        id: "money-03",
        title: "관점의 전환",
        body: "인간의 행복은 고민이나 괴로움을 일으키는 번뇌를 없애거나 번뇌에서 벗어나야만 얻을 수 있는 것이 아니라, 고민이나 괴로움을 안고 있는 자신의 생명 안에 보리(인생을 여는 지혜와 힘)가 있다고 보는 ‘관점의 전환’을 제시한 법리입니다. 문제는 번뇌의 괴로움이 아닙니다. 번뇌를 어떻게 바라보고 행동하느냐에 달렸습니다. - 제42회 ‘SGI의 날’ 기념제언 「희망을 여는 새벽종 청년의 대연대」",
        frontImage: ""
      },
      {
        id: "money-04",
        title: "원점으로 돌아가기",
        body: "마키쿠치 선생님도 ‘막히면 원점으로 되돌아가라’고 가르치셨습니다. ‘급할수록 돌아가라.’입니다. - 청춘대화 2권 p337",
        frontImage: ""
      },
      {
        id: "money-05",
        title: "승리를 여는 용기",
        body: "인생의 승리는 모두 용기에서 시작된다. 한 걸음 내딛는 용기, 좌절하지 않는 용기, 자신에게 지지 않는 용기. 용기만이 벽을 부술 수 있다. - 이케다 다이사쿠 명언100선中",
        frontImage: ""
      }
    ]
  }

const themes = [
  ...
  },
  {
    ...
    accentSoft: "#f08a7c",
    coverCharacters: [
      "assets/cards/characters/girl-thumb.webp",
      "assets/cards/characters/girl-wave.webp"
    ],
    speeches: [
      {
        id: "relationships-01",
  ...
  },
  {
    ...
    accentSoft: "#7aa9ee",
    coverCharacters: [
      "assets/cards/characters/man-pen.webp",
      "assets/cards/characters/man-tablet.webp"
    ],
    speeches: [
      {
        id: "career-01",
  ...
  },
  {
    ...
    accentSoft: "#e0b84c",
    coverCharacters: [
      "assets/cards/characters/woman-present.webp",
      "assets/cards/characters/man-books.webp"
    ],
    speeches: [
      {
        id: "money-01",
...
const speechLayouts = {
  ...
  "health-02": {
    fontSize: 50,
    lines: [
      "인간의 진정한 가치는 외모나 지위가 아닌",
      "정신의 도량에서 생긴다. 모든 것은 신심과",
      "확신에 달려있다. ‘마음이 어떠한가.",
      "행동이 어떠한가.’ 그것이 중요하다."
    ],
    characters: ["girl-thumb", "woman-present"]
  },
  "health-03": {
    fontSize: 48,
    lines: [
      "‘건강하다’와 ‘아프지 않다’는 같은",
      "의미가 아니다. 진정한 건강을 누리는 인생은",
      "가치를 창조하는 인생이다. 가치있고 의미있는",
      "일을 성취하기 위해 노력하는 인생이다.",
      "끊임없이 자신의 한계를 뛰어넘는 인생이다."
    ],
    characters: ["boy-fist", "girl-wave"]
  },
  "health-04": {
    fontSize: 48,
    lines: [
      "병도 인생의 일부이다. 불법의 관점에서",
      "보면 ‘반드시 돌파구를 열겠다!’고 결의하고",
      "병에 맞서 싸우는 용기가 중요하다. 진정한",
      "건강은 긍정적이고 건설적인 태도에 있다."
    ],
    characters: ["woman-clipboard", "man-tablet"]
  },
  "health-05": {
    fontSize: 46,
    lines: [
      "‘인정받고 싶다’, ‘이왕이면 더 좋게",
      "보이고 싶다’는 마음은 인간의 본성이다.",
      "하지만 그 욕구에 지배당하면 자신이 누구인지",
      "참된 목적이 무엇인지 망각하기 쉽다.",
      "거기에서부터 정신의 타락은 시작된다. 자기답게",
      "착실하게 살아가는 것이 최고의 모습이다."
    ],
    characters: ["girl-thumb", "man-books"]
  },
  "relationships-01": {
    fontSize: 41,
    lines: [
      "변함없는 우정은 어떠한 보배보다 존귀하다.",
      "술책이나 이해관계가 아니라, 진실한 우정을 맺고 그",
      "우정을 소중히 여기는 인생이 곧 빛나는 인생이다."
    ],
    characters: ["girl-thumb", "girl-wave"]
  },
  "relationships-02": {
    fontSize: 55,
    lines: [
      "‘사이좋게 지내자.’고 생각하는 사람은",
      "행복하다. ‘사이좋게 지내자.’고",
      "마음을 쓰고 행동하는 사람은 훌륭하다.",
      "마음이 깨끗하고 풍요로운 사람이다."
    ],
    characters: ["woman-present", "man-books"]
  },
  "relationships-03": {
    fontSize: 50,
    lines: [
      "친구와 한 약속은 반드시 지켜야 한다.",
      "그것이 진정한 우정을 의미한다. 그러나",
      "타인과 한 약속을 지키려면, 먼저 자신에게",
      "한 약속부터 지킬 줄 알아야 한다."
    ],
    characters: ["girl-wave", "boy-fist"]
  },
  "relationships-04": {
    fontSize: 42,
    lines: [
      "사람을 만나자. 타인과의 교류는 새롭고 신나는",
      "가능성을 열어준다. 사람을 만나면 마음이 촉발되고",
      "활력이 넘친다. 그리고 더 많은 만남으로 이어져",
      "우리의 삶도 우리의 세계도 한없이 넓어진다."
    ],
    characters: ["woman-clipboard", "man-pen"]
  },
  "relationships-05": {
    fontSize: 44,
    lines: [
      "한 사람의 마음이 다른 사람의 마음을 움직인다.",
      "자신의 마음이 닫혀있으면 타인의 마음의 문도",
      "굳게 닫혀버린다. 반면, 주변 모든 사람들을",
      "따스한 봄의 햇살처럼 감싸 자기편으로 만드는",
      "사람은 모두에게 소중하게 여겨지게 된다."
    ],
    characters: ["woman-present", "man-tablet"]
  },
  "career-01": {
    fontSize: 43,
    lines: [
      "모두 누구에게나 반드시 사명이 있습니다.",
      "자기만이 할 수 있는 사명이 있습니다.",
      "반드시 당신의 힘을 필요로 하는 사람이 반드시",
      "어딘가에 있습니다. … 그것을 발견하려면 우선",
      "눈앞의 ‘현실’에서 피하지 말아야 합니다."
    ],
    characters: ["man-pen", "man-tablet"]
  },
  "career-02": {
    fontSize: 41,
    lines: [
      "인생은 ‘마라톤’입니다. 처음에는 꼴찌라",
      "해도 상관없습니다. 그 때문에 자신을 포기하고",
      "달리지 않으면 그것으로 ‘끝’입니다. 보잘것없는",
      "인간이 되고 맙니다. 지금 꿈이 있는 사람도",
      "없는 사람도 어쨌든 계속 달려야 합니다."
    ],
    characters: ["girl-wave", "man-books"]
  },
  "career-03": {
    fontSize: 49,
    lines: [
      "결과는 아무래도 좋으니 우선 무엇인가를",
      "시작해야 합니다. 무엇인가 노력해 보아야",
      "합니다. 그러한 ‘도망가지 않는 습관’,",
      "‘노력하는 습관’을 만들어야 합니다."
    ],
    characters: ["boy-fist", "man-pen"]
  },
  "career-04": {
    fontSize: 43,
    lines: [
      "인간은 누구나 어떤 형태로든 콤플렉스를 가지고",
      "있습니다. … 중요한 것은 그 콤플렉스에",
      "‘지지 않는’ 것입니다. 그 어떤 콤플렉스가",
      "있다 해도 그것을 발판으로 삼아 인내하고",
      "‘두고 봐라!’ 하며 스스로를 격려하면서",
      "나아가야 합니다. ‘지지 않는 혼’입니다."
    ],
    characters: ["woman-clipboard", "man-tablet"]
  },
  "career-05": {
    fontSize: 43,
    lines: [
      "유유하게 노력하는 ‘습관’을 붙인 사람은",
      "장래 무슨 일이라도 극복할 수 있습니다.",
      "그 ‘습관’이 최고의 재산입니다. 그러므로",
      "지금 ‘눈앞의 과제에서 승리하라!’,",
      "‘무엇인가를 시작하자!’고 호소하고 싶습니다."
    ],
    characters: ["girl-thumb", "man-books"]
  },
  "money-01": {
    ...
    lines: [
      "지지 마라. 강한 마음에 행복이! 가장",
      "고생한 사람이 최후에는 가장 큰 행복을",
      "쟁취할 수 있다. 행복은 인내라는 대지에",
      "피는 꽃이라는 것을 잊지 말아야 한다."
    ],
    characters: ["woman-present", "man-books"]
  },
  "money-02": {
    fontSize: 40,
    lines: [
      "주위에서 ‘좋았다’고 칭찬받는 일은 바로",
      "불법자로서 지닌 ‘인간성의 힘’이라고 말할 수",
      "있습니다. ‘마음의 재’가 지닌 힘이 있기에",
      "사람들에게서 신뢰받고, 모범적인 존재로 높이",
      "평가받습니다. 불성이 빛나는 인간성으로 나타나고,",
      "그 훌륭함이 신심하지 않는 사람들도 감동시킵니다.",
      "‘저 사람은 정말 뭔가 다르다. 빛난다.’고",
      "신뢰받는 일이 불법의 확고한 실증입니다."
    ],
    characters: ["man-tablet", "woman-clipboard"]
  },
  "money-03": {
    fontSize: 44,
    lines: [
      "인간의 행복은 고민이나 괴로움을 일으키는 번뇌를",
      "없애거나 번뇌에서 벗어나야만 얻을 수 있는",
      "것이 아니라, 고민이나 괴로움을 안고 있는",
      "자신의 생명 안에 보리(인생을 여는 지혜와",
      "힘)가 있다고 보는 ‘관점의 전환’을 제시한",
      "법리입니다. 문제는 번뇌의 괴로움이 아닙니다.",
      "번뇌를 어떻게 바라보고 행동하느냐에 달렸습니다."
    ],
    characters: ["man-pen", "woman-present"]
  },
  "money-04": {
    fontSize: 58,
    lines: [
    ...
    characters: ["man-books", "boy-fist"]
  },
  "money-05": {
    fontSize: 44,
    lines: [
      "인생의 승리는 모두 용기에서 시작된다. 한 걸음",
      "내딛는 용기, 좌절하지 않는 용기, 자신에게",
      "지지 않는 용기. 용기만이 벽을 부술 수 있다."
    ],
    characters: ["woman-clipboard", "man-tablet"]
  }
};
...
function openSpeech(themeId, sourceButton) {
  ...
  saveInventory();
  renderBoard();
  renderSpotlight(theme, speech, sourceRect);
}

function getSpeechDensity(body) {
...
function renderSpeechFront(theme, speech) {
  const layout = speechLayouts[speech.id];
  const [startCharacter, endCharacter] = layout.characters;
  const fontScale = (layout.fontSize / 12.8).toFixed(4);
  const characterPath = (name) => `assets/cards/characters/${name}.webp`;
  ...
  return `
    <div class="speech-card theme-cover theme-cover--${theme.id}" data-speech-id="${speech.id}" data-density="${getSpeechDensity(speech.body)}" style="--speech-font-scale: ${fontScale}">
      ...
      <p class="speech-mobile-copy">${speech.body}</p>
      <img class="speech-character speech-character--start" src="${characterPath(startCharacter)}" alt="" decoding="async" />
      <img class="speech-character speech-character--end" src="${characterPath(endCharacter)}" alt="" decoding="async" />
      <span class="sr-only">남은 ${getRemaining(speech.id)}장 · 누적 ${counts[speech.id]}회</span>
    </div>
  `;
}

function renderSpotlight(theme, speech, sourceRect) {
  const style = [
    `--accent: ${theme.accent}`,
    `--accent-deep: ${theme.accentDeep}`,
    `--accent-soft: ${theme.accentSoft}`,
  ...
  spotlight.innerHTML = `
    <div class="flip-stage" style="${style}" data-flipped="false">
      <button class="flip-card" type="button" aria-label="${speech.title} 카드 닫기">
        ...
        <div class="flip-face flip-front" aria-hidden="true">
          ${renderSpeechFront(theme, speech)}
        </div>
      </button>
    </div>
  `;

...
스피치 도안 이미지가 준비되면 `assets` 폴더에 이미지를 넣고, `app.js`의 각 스피치 `image` 값에 경로를 입력하세요.
...
```js
{
  ...
  title: "아침 루틴",
  body: "하루의 컨디션은 ...",
  image: "./assets/health-01.png"
}
```

`image` 값이 비어 있으면 기본 색상 카드 디자인이 표시됩니다.
